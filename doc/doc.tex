...
\begin{document}
	...
	\subsubsection{Numerical accuracy of the integration}
		The stepsize of the integration is determined by the ration of the error of components to the $l2$ norm of $y$. An independent way of checking accuracy is to check if the lorentzian length of the tangent vector is constant. In nonrelativistic mechanics problems energy conservation provides the possibility of independent verification of precision.
