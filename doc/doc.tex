...
\begin{document}
	...
	\subsubsection{Redshift}
		\begin{figure}[H]
			\begin{tabular}{cc}
				\subcaptionbox{A}{\includegraphics[scale=0.9]{./figs/frontRedshift.pdf}}&
				\subcaptionbox{B}{\includegraphics[scale=0.9]{./figs/backRedshift.pdf}}\\
				\subcaptionbox{C}{\includegraphics[scale=0.9]{./figs/outRedshift.pdf}}&
				\subcaptionbox{D}{\includegraphics[scale=0.9]{./figs/sideRedshift.pdf}}
			\end{tabular}
			\caption{}
			\label{redshift}
		\end{figure}
